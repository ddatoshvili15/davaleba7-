describe('davaleba11.2', () => {
    ...
    it('manage address book', ()=> {
        cy.get('[href="https://automationteststore.com/index.php?rt=account/address"]').click()
    ...
    it('change pasword', () => {
        cy.get('[href="https://automationteststore.com/index.php?rt=account/password"]').click()
